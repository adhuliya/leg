...
public:
  ...
  void add(Pass *P) override {
    llvm::errs() << "AD: tools/opt/opt.cpp OptCustomPassManger::add() Adding Pass: "; //AD:delit
    llvm::errs() << P->getPassName() << "\n"; //AD:delit
...
static inline void addPass(legacy::PassManagerBase &PM, Pass *P) {
  llvm::errs() << "AD: tools/opt/opt.cpp addPass() Adding Pass: "; //AD:delit
  llvm::errs() << P->getPassName() << "\n"; //AD:delit
...
int main(int argc, char **argv) {
  llvm::errs() << "AD: tools/opt/opt.cpp:430 main() of opt\n"; //AD:delit
  ...
  if (PassPipeline.getNumOccurrences() > 0) {
    ...
    llvm::errs() << "AD: tools/opt/opt.cpp:620 main() of opt (new pass manager)\n"; //AD:delit
...
//>>BLOCK(ADDOPT.02)END
  ...
  for (unsigned i = 0; i < PassList.size(); ++i) {
    ...
    if (P) {
      PassKind Kind = P->getPassKind();
      llvm::errs() << "AD: tools/opt/opt.cpp opt main() Adding Pass: "; //AD:delit
      llvm::errs() << PassInf->getPassName() << "\n"; //AD:delit
      addPass(Passes, P);
  ...
  llvm::errs() << "AD: tools/opt/opt.cpp:835 opt main() call Passes.run()\n"; //AD:delit
  if (!RunTwice) {
